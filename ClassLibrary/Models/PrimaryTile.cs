...
namespace TilesAndNotifications.Models
{
    public class PrimaryTile
    {
        ...
        public string message2 { get; set; } = " At vero eos et accusamus etiusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident.";
